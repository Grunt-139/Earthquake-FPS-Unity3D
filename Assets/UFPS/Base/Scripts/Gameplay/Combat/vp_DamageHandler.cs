...
public class vp_DamageHandler : MonoBehaviour
{
	...
	//Armour
	public float maxArmour = 1.0f;
	public float currentArmour = 0.0f;
...
//		}
		...
		if(currentArmour > 0.0f)
		{
			float remainingDamage;
			currentArmour -= damage;
			if(currentArmour < 0.0f)
			{
				//If the currentArmour value is below 0 then the remaining damage that needs to be taken would be the positive version of that negative value
				remainingDamage = currentArmour * -1;
				currentArmour = 0;
